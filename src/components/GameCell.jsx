...
export function GameCell({
  ...
  const isSelected =
    ...
    (figure && dotted && selected?.figure?.color != figure?.color);
  ...
  return (
    <div
      ...
      className={clsx(
        className,
        "flex justify-center items-center relative select-none transition-colors relative",
        isMate
          ? "bg-red-500"
          : isChecked
          ? "bg-amber-400"
    ...
    >
      ...
      {/* {figure && dotted && (
        <div className="aspect-square h-[35%] bg-black/25 rounded-full absolute" />
      )} */}
    </div>
  );
}
